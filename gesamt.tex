...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\doctitle}{Analysis of Feature Importance in a Neural Network for Predicting the Remaining Useful Life of Aircraft Engines} 				% Titel der Arbeit
\newcommand{\doctype}{Master's Thesis}			% Dokumenttyp
\newcommand{\docauthor}{Callum Dew, B.Sc.}	    % Autor
\newcommand{\doclocation}{Karlsruhe}			% Erstellungsort
\newcommand{\betreuerI}{Joel Arweiler, M.Sc.}	% Betreuer1
...
% Hauptteil
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{kapitel/Introduction.tex}
\input{kapitel/Related_Work.tex}
\input{kapitel/Background.tex}
